...
/**
 * VmRecoveryPoint Class Doc Comment
 *
 * @category Class
 ...
 */
class VmRecoveryPoint implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'vm_recovery_point';
    ...
    protected static $openAPITypes = [
        ...
        'resources' => '\OpenAPI\Client\Model\RecoveryPointResources',
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $name when calling VmRecoveryPoint., must be smaller than or equal to 64.');
        }
     ...
     * Gets resources
     *
     * @return \OpenAPI\Client\Model\RecoveryPointResources|null
     */
     ...
     * Sets resources
     *
     * @param \OpenAPI\Client\Model\RecoveryPointResources|null $resources resources
     *
     * @return self
     */
