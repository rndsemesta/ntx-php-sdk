...
/**
 * FileItemDefStatus Class Doc Comment
 *
 * @category Class
 ...
 */
class FileItemDefStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'file_item_def_status';
    ...
    protected static $openAPITypes = [
        ...
        'resources' => '\OpenAPI\Client\Model\FileItemResourcesDefStatus',
        'description' => 'string'
    ];
    ...
    */
     ...
     * Sets name
     *
     * @param string $name file_item Name.
     *
     * @return self
     */
     ...
     * Sets state
     *
     * @param string|null $state The state of the file_item.
     *
     * @return self
     */
     ...
     * Sets message_list
     *
     * @param \OpenAPI\Client\Model\MessageResource[]|null $message_list Any error messages for the file_item, if in an error state.
     *
     * @return self
     */
     ...
     * Gets resources
     *
     * @return \OpenAPI\Client\Model\FileItemResourcesDefStatus
     */
     ...
     * Sets resources
     *
     * @param \OpenAPI\Client\Model\FileItemResourcesDefStatus $resources resources
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description A description for file_item.
     *
     * @return self
     */
