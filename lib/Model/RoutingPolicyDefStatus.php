...
/**
 * RoutingPolicyDefStatus Class Doc Comment
 *
 * @category Class
 ...
 */
class RoutingPolicyDefStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'routing_policy_def_status';
    ...
    protected static $openAPITypes = [
        ...
        'resources' => '\OpenAPI\Client\Model\RoutingPolicyResourcesDefStatus',
        'description' => 'string'
    ];
    ...
    */
     ...
     * Sets name
     *
     * @param string $name routing_policy Name.
     *
     * @return self
     */
     ...
     * Sets state
     *
     * @param string|null $state The state of the routing_policy.
     *
     * @return self
     */
     ...
     * Sets message_list
     *
     * @param \OpenAPI\Client\Model\MessageResource[]|null $message_list Any error messages for the routing_policy, if in an error state.
     *
     * @return self
     */
     ...
     * Gets resources
     *
     * @return \OpenAPI\Client\Model\RoutingPolicyResourcesDefStatus
     */
     ...
     * Sets resources
     *
     * @param \OpenAPI\Client\Model\RoutingPolicyResourcesDefStatus $resources resources
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description A description for routing_policy.
     *
     * @return self
     */
