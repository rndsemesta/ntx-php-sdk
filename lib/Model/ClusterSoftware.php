...
/**
 * ClusterSoftware Class Doc Comment
 *
 * @category Class
 ...
 */
class ClusterSoftware implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'cluster_software';
    ...
    {
        $this->setIfExists('status', $data ?? [], 'INSTALLED');
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['software_type'] === null) {
            $invalidProperties[] = "'software_type' can't be null";
        }
     ...
     * Sets status
     *
     * @param string|null $status Current software status.
     *
     * @return self
     */
