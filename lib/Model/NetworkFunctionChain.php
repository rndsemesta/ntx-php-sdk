...
/**
 * NetworkFunctionChain Class Doc Comment
 *
 * @category Class
 ...
 */
class NetworkFunctionChain implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'network_function_chain';
    ...
    protected static $openAPITypes = [
        'name' => 'string',
        'description' => 'string',
        'resources' => '\OpenAPI\Client\Model\NetworkFunctionChainResource',
    ...
    */
     ...
     * Sets name
     *
     * @param string $name Network function chain name.
     *
     * @return self
     */
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $name when calling NetworkFunctionChain., must be smaller than or equal to 64.');
        }
     ...
     * Sets description
     *
     * @param string|null $description A description for the network function chain.
     *
     * @return self
     */
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 64)) {
            throw new \InvalidArgumentException('invalid length for $description when calling NetworkFunctionChain., must be smaller than or equal to 64.');
        }
     ...
     * Gets resources
     *
     * @return \OpenAPI\Client\Model\NetworkFunctionChainResource
     */
     ...
     * Sets resources
     *
     * @param \OpenAPI\Client\Model\NetworkFunctionChainResource $resources resources
     *
     * @return self
     */
