...
/**
 * VpcRouteTable Class Doc Comment
 *
 * @category Class
 ...
 */
class VpcRouteTable implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'vpc_route_table';
    ...
    protected static $openAPITypes = [
        ...
        'description' => 'string',
        'resources' => '\OpenAPI\Client\Model\VpcRouteTableResources',
        'name' => 'string'
    ];
    ...
    */
     ...
     * Sets description
     *
     * @param string|null $description A description for vpc_route_table.
     *
     * @return self
     */
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $description when calling VpcRouteTable., must be smaller than or equal to 1000.');
        }
     ...
     * Gets resources
     *
     * @return \OpenAPI\Client\Model\VpcRouteTableResources
     */
     ...
     * Sets resources
     *
     * @param \OpenAPI\Client\Model\VpcRouteTableResources $resources resources
     *
     * @return self
     */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 256)) {
            throw new \InvalidArgumentException('invalid length for $name when calling VpcRouteTable., must be smaller than or equal to 256.');
        }
