 ...
 */
class Blueprint implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 256)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Blueprint., must be smaller than or equal to 256.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $description when calling Blueprint., must be smaller than or equal to 1000.');
        }
     ...
     * Gets resources
     *
     * @return \OpenAPI\Client\Model\BlueprintResources
     */
     ...
     * Sets resources
     *
     * @param \OpenAPI\Client\Model\BlueprintResources $resources resources
     *
     * @return self
     */
