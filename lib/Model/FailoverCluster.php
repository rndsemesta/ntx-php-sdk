...
/**
 * FailoverCluster Class Doc Comment
 *
 * @category Class
 ...
 */
class FailoverCluster implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'failover_cluster';
    ...
    */
     ...
     * Sets ip
     *
     * @param string|null $ip IP address of the failover cluster.
     *
     * @return self
     */
    public function setIp($ip)
    {
        ...
        if ((!preg_match("/^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$/", ObjectSerializer::toString($ip)))) {
            throw new \InvalidArgumentException("invalid value for \$ip when calling FailoverCluster., must conform to the pattern /^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$/.");
        }
     ...
     * Sets name
     *
     * @param string|null $name Name of the failover cluster.
     *
     * @return self
     */
