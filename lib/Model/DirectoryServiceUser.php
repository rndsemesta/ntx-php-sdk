...
/**
 * DirectoryServiceUser Class Doc Comment
 *
 * @category Class
 ...
 */
class DirectoryServiceUser implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'directory_service_user';
    ...
    protected static $setters = [
        ...
        'user_attribute_value' => 'setUserAttributeValue'
    ];
    ...
    protected static $getters = [
        ...
        'user_attribute_value' => 'getUserAttributeValue'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('user_attribute_value', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['user_attribute_value']) && (mb_strlen($this->container['user_attribute_value']) > 104)) {
            $invalidProperties[] = "invalid value for 'user_attribute_value', the character length must be smaller than or equal to 104.";
        }
     ...
     *
     * @param string|null $user_principal_name The UserPrincipalName of the user from the directory service.
     *
     * @return self
     */
    public function setUserPrincipalName($user_principal_name)
    {
        ...
        if ((mb_strlen($user_principal_name) > 104)) {
            throw new \InvalidArgumentException('invalid length for $user_principal_name when calling DirectoryServiceUser., must be smaller than or equal to 104.');
        }
    ...
    /**
     * Gets user_attribute_value
     *
     * @return string|null
     */
    public function getUserAttributeValue()
    {
        return $this->container['user_attribute_value'];
    }

    /**
     * Sets user_attribute_value
     *
     * @param string|null $user_attribute_value The Unique identifier for each user from the directory service.
     *
     * @return self
     */
    public function setUserAttributeValue($user_attribute_value)
    {
        if (is_null($user_attribute_value)) {
            throw new \InvalidArgumentException('non-nullable user_attribute_value cannot be null');
        }
        if ((mb_strlen($user_attribute_value) > 104)) {
            throw new \InvalidArgumentException('invalid length for $user_attribute_value when calling DirectoryServiceUser., must be smaller than or equal to 104.');
        }

        $this->container['user_attribute_value'] = $user_attribute_value;
