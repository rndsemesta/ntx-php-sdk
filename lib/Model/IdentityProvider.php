...
class IdentityProvider implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'identity_provider';
    ...
    protected static $openAPITypes = [
        'name' => 'string',
        'resources' => '\OpenAPI\Client\Model\IdentityProviderResources'
    ];
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $name when calling IdentityProvider., must be smaller than or equal to 64.');
        }
     ...
     * Gets resources
     *
     * @return \OpenAPI\Client\Model\IdentityProviderResources
     */
     ...
     * Sets resources
     *
     * @param \OpenAPI\Client\Model\IdentityProviderResources $resources resources
     *
     * @return self
     */
