...
/**
 * VpcRouteTableDefStatus Class Doc Comment
 *
 * @category Class
 ...
 */
class VpcRouteTableDefStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'vpc_route_table_def_status';
    ...
    protected static $openAPITypes = [
        ...
        'resources' => '\OpenAPI\Client\Model\VpcRouteTableResourcesDefStatus',
        'description' => 'string'
    ];
    ...
    */
     ...
     * Sets name
     *
     * @param string $name vpc_route_table Name.
     *
     * @return self
     */
     ...
     * Sets state
     *
     * @param string|null $state The state of the vpc_route_table.
     *
     * @return self
     */
     ...
     * Sets message_list
     *
     * @param \OpenAPI\Client\Model\MessageResource[]|null $message_list Any error messages for the vpc_route_table, if in an error state.
     *
     * @return self
     */
     ...
     * Gets resources
     *
     * @return \OpenAPI\Client\Model\VpcRouteTableResourcesDefStatus
     */
     ...
     * Sets resources
     *
     * @param \OpenAPI\Client\Model\VpcRouteTableResourcesDefStatus $resources resources
     *
     * @return self
     */
