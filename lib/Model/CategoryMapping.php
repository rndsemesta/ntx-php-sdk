...
/**
 * CategoryMapping Class Doc Comment
 *
 * @category Class
 ...
 */
class CategoryMapping implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'category_mapping';
    ...
    protected static $openAPITypes = [
        ...
        'description' => 'string',
        'resources' => '\OpenAPI\Client\Model\CategoryMappingResources',
        'name' => 'string'
    ];
    ...
    */
     ...
     * Sets description
     *
     * @param string|null $description A description for category_mapping.
     *
     * @return self
     */
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $description when calling CategoryMapping., must be smaller than or equal to 1000.');
        }
     ...
     * Gets resources
     *
     * @return \OpenAPI\Client\Model\CategoryMappingResources
     */
     ...
     * Sets resources
     *
     * @param \OpenAPI\Client\Model\CategoryMappingResources $resources resources
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name category_mapping Name.
     *
     * @return self
     */
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 256)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CategoryMapping., must be smaller than or equal to 256.');
        }
