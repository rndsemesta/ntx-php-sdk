...
/**
 * VpcDefStatus Class Doc Comment
 *
 * @category Class
 ...
 */
class VpcDefStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'vpc_def_status';
    ...
    protected static $openAPITypes = [
        ...
        'name' => 'string',
        'resources' => '\OpenAPI\Client\Model\VpcResourcesDefStatus',
        'description' => 'string'
    ];
    ...
    */
     ...
     * Sets state
     *
     * @param string|null $state The state of the VPC.
     *
     * @return self
     */
     ...
     * Sets message_list
     *
     * @param \OpenAPI\Client\Model\MessageResource[]|null $message_list Any error messages for the VPC, if in an error state.
     *
     * @return self
     */
     ...
     * Gets resources
     *
     * @return \OpenAPI\Client\Model\VpcResourcesDefStatus|null
     */
     ...
     * Sets resources
     *
     * @param \OpenAPI\Client\Model\VpcResourcesDefStatus|null $resources resources
     *
     * @return self
     */
