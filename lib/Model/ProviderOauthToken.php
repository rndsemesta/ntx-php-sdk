...
/**
 * ProviderOauthToken Class Doc Comment
 *
 * @category Class
 ...
 */
class ProviderOauthToken implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'provider_oauth_token';
    ...
    */
     ...
     * Sets access_token
     *
     * @param string $access_token access_token to be used for accessing gateway
     *
     * @return self
     */
     ...
     * Sets token_type
     *
     * @param string $token_type Only value possible is \"bearer\".
     *
     * @return self
     */
     ...
     * Sets refresh_token
     *
     * @param string $refresh_token Refresh_token which can used to get new token
     *
     * @return self
     */
     ...
     * Sets scope
     *
     * @param string $scope Scope string with individual scopes separated by space
     *
     * @return self
     */
