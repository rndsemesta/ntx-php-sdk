...
/**
 * RecoveryPlanValidationMessageCauseAndResolutionMessageListInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RecoveryPlanValidationMessageCauseAndResolutionMessageListInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'recovery_plan_validation_message_cause_and_resolution_message_list_inner';
    ...
    */
     ...
     *
     * @param string[]|null $resolution_list Steps to resolve the warning or error.
     *
     * @return self
     */
     ...
     * Sets cause
     *
     * @param string $cause Cause of the validation warning or error.
     *
     * @return self
     */
