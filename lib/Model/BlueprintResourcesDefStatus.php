...
/**
 * BlueprintResourcesDefStatus Class Doc Comment
 *
 * @category Class
 ...
 */
class BlueprintResourcesDefStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'blueprint_resources_def_status';
    ...
    protected static $openAPITypes = [
        ...
        'service_definition_list' => '\OpenAPI\Client\Model\AppServiceResponse[]',
        'substrate_definition_list' => '\OpenAPI\Client\Model\AppSubstrateResponse[]',
        'credential_definition_list' => '\OpenAPI\Client\Model\AppCredentialResponse[]',
        'package_definition_list' => '\OpenAPI\Client\Model\AppPackageResponse[]',
        'app_profile_list' => '\OpenAPI\Client\Model\AppProfileResponse[]',
        'published_service_definition_list' => '\OpenAPI\Client\Model\AppPublishedServiceResponse[]',
        'default_credential_local_reference' => '\OpenAPI\Client\Model\AppCredentialReference',
        'state' => 'string',
        'type' => 'string',
    ...
    */
     ...
     *
     * @param \OpenAPI\Client\Model\AppServiceResponse[]|null $service_definition_list Service definitions for Blueprint.
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\AppSubstrateResponse[]|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\AppSubstrateResponse[]|null $substrate_definition_list Substrate definitions for Blueprint.
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\AppCredentialResponse[]|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\AppCredentialResponse[]|null $credential_definition_list Credential definitions for Blueprint.
     *
     * @return self
     */
     ...
     *
     * @param \OpenAPI\Client\Model\AppPackageResponse[]|null $package_definition_list Package definitions for Blueprint.
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\AppProfileResponse[]|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\AppProfileResponse[]|null $app_profile_list App profile definitions for Blueprint.
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\AppPublishedServiceResponse[]|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\AppPublishedServiceResponse[]|null $published_service_definition_list Published service definitions for Blueprint.
     *
     * @return self
     */
     ...
     *
     * @param \OpenAPI\Client\Model\AppCredentialReference|null $default_credential_local_reference default_credential_local_reference
     *
     * @return self
     */
    ...
    public function setType($type)
    {
        ...
        if ((mb_strlen($type) > 64)) {
            throw new \InvalidArgumentException('invalid length for $type when calling BlueprintResourcesDefStatus., must be smaller than or equal to 64.');
        }
