...
class Subnet implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'description' => 'string',
        'resources' => '\OpenAPI\Client\Model\SubnetResources',
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 256)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Subnet., must be smaller than or equal to 256.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $description when calling Subnet., must be smaller than or equal to 1000.');
        }
     ...
     * Gets resources
     *
     * @return \OpenAPI\Client\Model\SubnetResources
     */
     ...
     * Sets resources
     *
     * @param \OpenAPI\Client\Model\SubnetResources $resources resources
     *
     * @return self
     */
