...
/**
 * StreamingPolicyDefStatus Class Doc Comment
 *
 * @category Class
 ...
 */
class StreamingPolicyDefStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'streaming_policy_def_status';
    ...
    protected static $openAPITypes = [
        ...
        'name' => 'string',
        'resources' => '\OpenAPI\Client\Model\StreamingPolicyDetails',
        'description' => 'string'
    ];
    ...
    */
     ...
     * Sets state
     *
     * @param string|null $state The state of the streaming policy.
     *
     * @return self
     */
     ...
     * Sets message_list
     *
     * @param \OpenAPI\Client\Model\MessageResource[]|null $message_list Any error messages for the streaming policy, if in an error state.
     *
     * @return self
     */
     ...
     * Gets resources
     *
     * @return \OpenAPI\Client\Model\StreamingPolicyDetails
     */
     ...
     * Sets resources
     *
     * @param \OpenAPI\Client\Model\StreamingPolicyDetails $resources resources
     *
     * @return self
     */
