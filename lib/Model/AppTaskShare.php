...
/**
 * AppTaskShare Class Doc Comment
 *
 * @category Class
 ...
 */
class AppTaskShare implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'app_task_share';
    ...
    protected static $openAPITypes = [
        ...
        'description' => 'string',
        'resources' => '\OpenAPI\Client\Model\AppTaskShareResources',
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $name when calling AppTaskShare., must be smaller than or equal to 64.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $description when calling AppTaskShare., must be smaller than or equal to 1000.');
        }
     ...
     * Gets resources
     *
     * @return \OpenAPI\Client\Model\AppTaskShareResources
     */
     ...
     * Sets resources
     *
     * @param \OpenAPI\Client\Model\AppTaskShareResources $resources resources
     *
     * @return self
     */
