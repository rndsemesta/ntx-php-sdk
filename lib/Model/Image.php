...
class Image implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'name' => 'string',
        'resources' => '\OpenAPI\Client\Model\ImageResources',
        'description' => 'string'
    ];
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 256)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Image., must be smaller than or equal to 256.');
        }
     ...
     * Gets resources
     *
     * @return \OpenAPI\Client\Model\ImageResources
     */
     ...
     * Sets resources
     *
     * @param \OpenAPI\Client\Model\ImageResources $resources resources
     *
     * @return self
     */
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $description when calling Image., must be smaller than or equal to 1000.');
        }
