<?php
/**
 * VmHostAffinityPolicyUpdateMetadata
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * VmHostAffinityPolicyUpdateMetadata Class Doc Comment
 *
 * @category Class
 ...
 */
class VmHostAffinityPolicyUpdateMetadata implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'vm_host_affinity_policy_update_metadata';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['entity_version'] === null) {
            $invalidProperties[] = "'entity_version' can't be null";
        }
     ...
     * Sets entity_version
     *
     * @param int $entity_version Logical timestamp of VM Host Affinity Policy.
     *
     * @return self
     */
