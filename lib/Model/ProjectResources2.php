...
/**
 * ProjectResources2 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ProjectResources2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Project_Resources_2';
    ...
    protected static $openAPITypes = [
        'resource_domain' => '\OpenAPI\Client\Model\ResourceDomainResourcesStatus',
    ...
    */
     ...
     *
     * @return \OpenAPI\Client\Model\ResourceDomainResourcesStatus|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\ResourceDomainResourcesStatus|null $resource_domain resource_domain
     *
     * @return self
     */
     ...
     *
     * @param \OpenAPI\Client\Model\UserReference[]|null $user_reference_list List of users added directly to the project.
     *
     * @return self
     */
     ...
     * Sets is_default
     *
     * @param bool|null $is_default Indicates if it is the default project.
     *
     * @return self
     */
     ...
     *
     * @param \OpenAPI\Client\Model\UserGroupReference[]|null $external_user_group_reference_list List of directory service groups reference. These groups are not managed by Nutanix.
     *
     * @return self
     */
     ...
     *
     * @param \OpenAPI\Client\Model\ExternalNetwork[]|null $external_network_list List of external network associated with the project.
     *
     * @return self
     */
