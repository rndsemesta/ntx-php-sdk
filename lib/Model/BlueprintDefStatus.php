...
/**
 * BlueprintDefStatus Class Doc Comment
 *
 * @category Class
 ...
 */
class BlueprintDefStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'blueprint_def_status';
    ...
    */
     ...
     * Sets state
     *
     * @param string|null $state The state of the blueprint.
     *
     * @return self
     */
     ...
     * Sets message_list
     *
     * @param \OpenAPI\Client\Model\MessageResource[]|null $message_list Any error messages for the blueprint, if in an error state.
     *
     * @return self
     */
     ...
     * Gets resources
     *
     * @return \OpenAPI\Client\Model\BlueprintResourcesDefStatus
     */
     ...
     * Sets resources
     *
     * @param \OpenAPI\Client\Model\BlueprintResourcesDefStatus $resources resources
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description A description for blueprint.
     *
     * @return self
     */
