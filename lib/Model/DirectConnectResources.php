...
/**
 * DirectConnectResources Class Doc Comment
 *
 * @category Class
 ...
 */
class DirectConnectResources implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'direct_connect_resources';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['service_provider']) > 64)) {
            $invalidProperties[] = "invalid value for 'service_provider', the character length must be smaller than or equal to 64.";
        }

        if ($this->container['bandwidth_mbps'] === null) {
            $invalidProperties[] = "'bandwidth_mbps' can't be null";
        }
        if (($this->container['bandwidth_mbps'] < 1)) {
            $invalidProperties[] = "invalid value for 'bandwidth_mbps', must be bigger than or equal to 1.";
        }
     ...
     *
     * @param string $service_provider The name of the service provider to be utilized for this direct connnect.
     *
     * @return self
     */
    public function setServiceProvider($service_provider)
    {
        ...
        if ((mb_strlen($service_provider) > 64)) {
            throw new \InvalidArgumentException('invalid length for $service_provider when calling DirectConnectResources., must be smaller than or equal to 64.');
        }
     ...
     * Sets bandwidth_mbps
     *
     * @param int $bandwidth_mbps Direct connect total bandwidth in Mbps.
     *
     * @return self
     */
    public function setBandwidthMbps($bandwidth_mbps)
    {
        ...
        if (($bandwidth_mbps < 1)) {
            throw new \InvalidArgumentException('invalid value for $bandwidth_mbps when calling DirectConnectResources., must be bigger than or equal to 1.');
        }
