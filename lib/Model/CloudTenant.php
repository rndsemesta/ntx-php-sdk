 ...
 */
class CloudTenant implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'cloud_tenant';
    ...
    protected static $openAPITypes = [
        ...
        'description' => 'string',
        'resources' => '\OpenAPI\Client\Model\CloudTenantResources',
        'name' => 'string'
    ];
    ...
    */
     ...
     * Sets description
     *
     * @param string|null $description A description for cloud_tenant.
     *
     * @return self
     */
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $description when calling CloudTenant., must be smaller than or equal to 1000.');
        }
     ...
     * Gets resources
     *
     * @return \OpenAPI\Client\Model\CloudTenantResources
     */
     ...
     * Sets resources
     *
     * @param \OpenAPI\Client\Model\CloudTenantResources $resources resources
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name cloud_tenant Name.
     *
     * @return self
     */
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 256)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CloudTenant., must be smaller than or equal to 256.');
        }
