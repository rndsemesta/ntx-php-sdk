 ...
 */
class AwsVm implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'aws_vm';
    ...
    protected static $openAPITypes = [
        ...
        'description' => 'string',
        'resources' => '\OpenAPI\Client\Model\AwsVmResources',
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 256)) {
            throw new \InvalidArgumentException('invalid length for $name when calling AwsVm., must be smaller than or equal to 256.');
        }
     ...
     * Sets description
     *
     * @param string|null $description A description for aws_vm.
     *
     * @return self
     */
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $description when calling AwsVm., must be smaller than or equal to 1000.');
        }
     ...
     * Gets resources
     *
     * @return \OpenAPI\Client\Model\AwsVmResources
     */
     ...
     * Sets resources
     *
     * @param \OpenAPI\Client\Model\AwsVmResources $resources resources
     *
     * @return self
     */
