 ...
 */
class SerialPort implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'serial_port';
    ...
    */
     ...
     * Sets index
     *
     * @param int|null $index Index of the serial port.
     *
     * @return self
     */
     ...
     * Sets is_connected
     *
     * @param bool|null $is_connected Indicates whether the serial port connection is connected or not.
     *
     * @return self
     */
