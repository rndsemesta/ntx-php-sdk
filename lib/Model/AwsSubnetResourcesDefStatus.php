...
/**
 * AwsSubnetResourcesDefStatus Class Doc Comment
 *
 * @category Class
 ...
 */
class AwsSubnetResourcesDefStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'aws_subnet_resources_def_status';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['id']) && !preg_match("/^subnet-[a-f0-9]{1,17}$/", $this->container['id'])) {
            $invalidProperties[] = "invalid value for 'id', must be conform to the pattern /^subnet-[a-f0-9]{1,17}$/.";
        }
     ...
     * Sets vpc_id
     *
     * @param string|null $vpc_id The AWS ID of the VPC the subnet is in.
     *
     * @return self
     */
    public function setVpcId($vpc_id)
    {
        ...
        if ((!preg_match("/^vpc-[a-f0-9]{1,17}$/", ObjectSerializer::toString($vpc_id)))) {
            throw new \InvalidArgumentException("invalid value for \$vpc_id when calling AwsSubnetResourcesDefStatus., must conform to the pattern /^vpc-[a-f0-9]{1,17}$/.");
        }
     ...
     * Sets cidr_block
     *
     * @param string|null $cidr_block The CIDR block assigned to the subnet.
     *
     * @return self
     */
    public function setCidrBlock($cidr_block)
    {
        ...
        if ((mb_strlen($cidr_block) > 64)) {
            throw new \InvalidArgumentException('invalid length for $cidr_block when calling AwsSubnetResourcesDefStatus., must be smaller than or equal to 64.');
        }
     ...
     * Sets id
     *
     * @param string|null $id The AWS ID of the subnet.
     *
     * @return self
     */
    public function setId($id)
    {
        ...
        if ((!preg_match("/^subnet-[a-f0-9]{1,17}$/", ObjectSerializer::toString($id)))) {
            throw new \InvalidArgumentException("invalid value for \$id when calling AwsSubnetResourcesDefStatus., must conform to the pattern /^subnet-[a-f0-9]{1,17}$/.");
        }
