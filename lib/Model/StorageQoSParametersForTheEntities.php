...
/**
 * StorageQoSParametersForTheEntities Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class StorageQoSParametersForTheEntities implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Storage_QoS_parameters_for_the_entities_';
    ...
    */
     ...
     * Sets throttled_iops
     *
     * @param int|null $throttled_iops Throttled IOPS for the entities being governed. The block size for the IO is 32kB.
     *
     * @return self
     */
