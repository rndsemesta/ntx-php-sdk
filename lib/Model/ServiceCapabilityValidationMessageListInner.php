...
/**
 * ServiceCapabilityValidationMessageListInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ServiceCapabilityValidationMessageListInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'service_capability_validation_message_list_inner';
    ...
    */
     ...
     * Sets error_detail
     *
     * @param string|null $error_detail The error detail for the validation failure.
     *
     * @return self
     */
     ...
     *
     * @param string|null $validation_type The type of validation performed.
     *
     * @return self
     */
