...
/**
 * BlueprintUploadResources Class Doc Comment
 *
 * @category Class
 ...
 */
class BlueprintUploadResources implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'blueprint_upload_resources';
    ...
    protected static $openAPITypes = [
        ...
        'service_definition_list' => '\OpenAPI\Client\Model\AppServiceInputUpload[]',
        'substrate_definition_list' => '\OpenAPI\Client\Model\AppSubstrateInputUpload[]',
        'credential_definition_list' => '\OpenAPI\Client\Model\AppCredentialInputUpload[]',
        'package_definition_list' => '\OpenAPI\Client\Model\AppPackageInputUpload[]',
        'app_profile_list' => '\OpenAPI\Client\Model\AppProfileInputUpload[]',
        'published_service_definition_list' => '\OpenAPI\Client\Model\AppPublishedServiceInputUpload[]',
    ...
    */
     ...
     *
     * @return \OpenAPI\Client\Model\AppServiceInputUpload[]|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\AppServiceInputUpload[]|null $service_definition_list Service definitions for Blueprint.
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\AppSubstrateInputUpload[]|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\AppSubstrateInputUpload[]|null $substrate_definition_list Substrate definitions for Blueprint.
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\AppCredentialInputUpload[]|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\AppCredentialInputUpload[]|null $credential_definition_list Credential definitions for Blueprint.
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\AppPackageInputUpload[]|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\AppPackageInputUpload[]|null $package_definition_list Package definitions for Blueprint.
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\AppProfileInputUpload[]|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\AppProfileInputUpload[]|null $app_profile_list App profile definitions for Blueprint.
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\AppPublishedServiceInputUpload[]|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\AppPublishedServiceInputUpload[]|null $published_service_definition_list Published service definitions for Blueprint.
     *
     * @return self
     */
    ...
    public function setType($type)
    {
        ...
        if ((mb_strlen($type) > 64)) {
            throw new \InvalidArgumentException('invalid length for $type when calling BlueprintUploadResources., must be smaller than or equal to 64.');
        }
