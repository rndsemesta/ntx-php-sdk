...
/**
 * BlueprintUpload Class Doc Comment
 *
 * @category Class
 ...
 */
class BlueprintUpload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'blueprint_upload';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $name when calling BlueprintUpload., must be smaller than or equal to 64.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $description when calling BlueprintUpload., must be smaller than or equal to 1000.');
        }
