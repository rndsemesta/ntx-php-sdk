...
/**
 * BlueprintResources Class Doc Comment
 *
 * @category Class
 ...
 */
class BlueprintResources implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'blueprint_resources';
    ...
    protected static $openAPITypes = [
        ...
        'service_definition_list' => '\OpenAPI\Client\Model\AppServiceInput[]',
        ...
        'package_definition_list' => '\OpenAPI\Client\Model\AppPackageInput[]',
        'app_profile_list' => '\OpenAPI\Client\Model\AppProfileInput[]',
        'published_service_definition_list' => '\OpenAPI\Client\Model\AppPublishedServiceInput[]',
    ...
    */
     ...
     *
     * @param \OpenAPI\Client\Model\AppServiceInput[]|null $service_definition_list Service definitions for Blueprint.
     *
     * @return self
     */
     ...
     *
     * @param \OpenAPI\Client\Model\AppSubstrateInput[]|null $substrate_definition_list Substrate definitions for Blueprint.
     *
     * @return self
     */
     ...
     *
     * @param \OpenAPI\Client\Model\AppCredentialInput[]|null $credential_definition_list Credential definitions for Blueprint.
     *
     * @return self
     */
     ...
     *
     * @param \OpenAPI\Client\Model\AppPackageInput[]|null $package_definition_list Package definitions for Blueprint.
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\AppProfileInput[]|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\AppProfileInput[]|null $app_profile_list App profile definitions for Blueprint.
     *
     * @return self
     */
     ...
     *
     * @param \OpenAPI\Client\Model\AppPublishedServiceInput[]|null $published_service_definition_list Published service definitions for Blueprint.
     *
     * @return self
     */
    ...
    public function setType($type)
    {
        ...
        if ((mb_strlen($type) > 64)) {
            throw new \InvalidArgumentException('invalid length for $type when calling BlueprintResources., must be smaller than or equal to 64.');
        }
