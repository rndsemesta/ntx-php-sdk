...
/**
 * PcVmNicConfiguration Class Doc Comment
 *
 * @category Class
 ...
 */
class PcVmNicConfiguration implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'pc_vm_nic_configuration';
    ...
    protected static $openAPITypes = [
        'network_configuration' => '\OpenAPI\Client\Model\NetworkConfig',
        'ip_list' => 'string[]'
    ];
    ...
    {
        $this->setIfExists('network_configuration', $data ?? [], null);
    ...
    */
     ...
     *
     * @param \OpenAPI\Client\Model\NetworkConfig|null $network_configuration network_configuration
     *
     * @return self
     */
    public function setNetworkConfiguration($network_configuration)
    {
        if (is_null($network_configuration)) {
            throw new \InvalidArgumentException('non-nullable network_configuration cannot be null');
        }
     ...
     * Sets ip_list
     *
     * @param string[]|null $ip_list Network IP address.
     *
     * @return self
     */
