<?php
/**
 * UserUsageInProjectsProjectResourceDomainListInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * UserUsageInProjectsProjectResourceDomainListInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UserUsageInProjectsProjectResourceDomainListInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'user_usage_in_projects_project_resource_domain_list_inner';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['project_reference'] === null) {
            $invalidProperties[] = "'project_reference' can't be null";
        }
        if ($this->container['resource_domain'] === null) {
            $invalidProperties[] = "'resource_domain' can't be null";
        }
     ...
     *
     * @return \OpenAPI\Client\Model\ProjectReference
     */
     ...
     *
     * @param \OpenAPI\Client\Model\ProjectReference $project_reference project_reference
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\ResourceDomainResourcesStatus
     */
     ...
     *
     * @param \OpenAPI\Client\Model\ResourceDomainResourcesStatus $resource_domain resource_domain
     *
     * @return self
     */
