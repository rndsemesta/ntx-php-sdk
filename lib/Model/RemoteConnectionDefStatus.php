...
/**
 * RemoteConnectionDefStatus Class Doc Comment
 *
 * @category Class
 ...
 */
class RemoteConnectionDefStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'remote_connection_def_status';
    ...
    */
     ...
     * Sets state
     *
     * @param string|null $state The state of the remote connection entity.
     *
     * @return self
     */
