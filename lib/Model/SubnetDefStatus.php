...
/**
 * SubnetDefStatus Class Doc Comment
 *
 * @category Class
 ...
 */
class SubnetDefStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'subnet_def_status';
    ...
    protected static $openAPITypes = [
        ...
        'resources' => '\OpenAPI\Client\Model\SubnetResourcesDefStatus',
        'description' => 'string'
    ];
    ...
    */
     ...
     * Sets state
     *
     * @param string|null $state The state of the subnet.
     *
     * @return self
     */
     ...
     * Sets message_list
     *
     * @param \OpenAPI\Client\Model\MessageResource[]|null $message_list Any error messages for the subnet, if in an error state.
     *
     * @return self
     */
     ...
     * Gets resources
     *
     * @return \OpenAPI\Client\Model\SubnetResourcesDefStatus
     */
     ...
     * Sets resources
     *
     * @param \OpenAPI\Client\Model\SubnetResourcesDefStatus $resources resources
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description A description for subnet.
     *
     * @return self
     */
