...
/**
 * RecoveryPlanVmIpAssignmentIpConfigListInner Class Doc Comment
 *
 * @category Class
 ...
 */
class RecoveryPlanVmIpAssignmentIpConfigListInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'recovery_plan_vm_ip_assignment_ip_config_list_inner';
    ...
    */
    ...
    public function setIpAddress($ip_address)
    {
        ...
        if ((!preg_match("/^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$/", ObjectSerializer::toString($ip_address)))) {
            throw new \InvalidArgumentException("invalid value for \$ip_address when calling RecoveryPlanVmIpAssignmentIpConfigListInner., must conform to the pattern /^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$/.");
        }
