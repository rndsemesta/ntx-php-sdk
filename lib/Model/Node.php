...
class Node implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['host_reference'] === null) {
            $invalidProperties[] = "'host_reference' can't be null";
        }
     ...
     * Sets host_reference
     *
     * @param \OpenAPI\Client\Model\Reference $host_reference host_reference
     *
     * @return self
     */
     ...
     * Sets ip_address
     *
     * @param string|null $ip_address Node IP Address
     *
     * @return self
     */
    public function setIpAddress($ip_address)
    {
        ...
        if ((!preg_match("/^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$/", ObjectSerializer::toString($ip_address)))) {
            throw new \InvalidArgumentException("invalid value for \$ip_address when calling Node., must conform to the pattern /^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$/.");
        }
