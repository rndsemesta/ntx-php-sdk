...
/**
 * RecoveryPlanJobDefStatusRecoveryPlanSpecification Class Doc Comment
 *
 * @category Class
 ...
 */
class RecoveryPlanJobDefStatusRecoveryPlanSpecification implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'recovery_plan_job_def_status_recovery_plan_specification';
    ...
    */
     ...
     * Sets description
     *
     * @param string|null $description User provided description for the Recovery Plan.
     *
     * @return self
     */
