...
/**
 * VpnGatewayDefStatus Class Doc Comment
 *
 * @category Class
 ...
 */
class VpnGatewayDefStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'vpn_gateway_def_status';
    ...
    protected static $openAPITypes = [
        ...
        'resources' => '\OpenAPI\Client\Model\VpnGatewayResourcesDefStatus',
        'description' => 'string'
    ];
    ...
    */
     ...
     * Sets state
     *
     * @param string|null $state The state of the vpn_gateway.
     *
     * @return self
     */
     ...
     * Sets message_list
     *
     * @param \OpenAPI\Client\Model\MessageResource[]|null $message_list Any error messages for the vpn_gateway, if in an error state.
     *
     * @return self
     */
     ...
     * Gets resources
     *
     * @return \OpenAPI\Client\Model\VpnGatewayResourcesDefStatus
     */
     ...
     * Sets resources
     *
     * @param \OpenAPI\Client\Model\VpnGatewayResourcesDefStatus $resources resources
     *
     * @return self
     */
