...
/**
 * PermissionDefStatus Class Doc Comment
 *
 * @category Class
 ...
 */
class PermissionDefStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'permission_def_status';
    ...
    */
     ...
     * Sets state
     *
     * @param string|null $state The state of the permission entity.
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description Human readable description of the permission.
     *
     * @return self
     */
