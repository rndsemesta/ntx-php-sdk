...
/**
 * VmRecoveryPointDefStatus Class Doc Comment
 *
 * @category Class
 ...
 */
class VmRecoveryPointDefStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'vm_recovery_point_def_status';
    ...
    protected static $openAPITypes = [
        ...
        'resources' => '\OpenAPI\Client\Model\RecoveryPointResources1'
    ];
    ...
    */
     ...
     * Sets state
     *
     * @param string|null $state The state of the vm recovery point.
     *
     * @return self
     */
     ...
     * Sets message_list
     *
     * @param \OpenAPI\Client\Model\MessageResource[]|null $message_list Any error messages for the vm, if in an error state.
     *
     * @return self
     */
     ...
     * Gets resources
     *
     * @return \OpenAPI\Client\Model\RecoveryPointResources1|null
     */
     ...
     * Sets resources
     *
     * @param \OpenAPI\Client\Model\RecoveryPointResources1|null $resources resources
     *
     * @return self
     */
