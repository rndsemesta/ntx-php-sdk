 ...
 */
class FloatingIp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'floating_ip';
    ...
    protected static $openAPITypes = [
        ...
        'description' => 'string',
        'resources' => '\OpenAPI\Client\Model\FloatingIpResources',
        'name' => 'string'
    ];
    ...
    */
     ...
     * Sets description
     *
     * @param string|null $description A description for floating_ip.
     *
     * @return self
     */
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $description when calling FloatingIp., must be smaller than or equal to 1000.');
        }
     ...
     * Gets resources
     *
     * @return \OpenAPI\Client\Model\FloatingIpResources
     */
     ...
     * Sets resources
     *
     * @param \OpenAPI\Client\Model\FloatingIpResources $resources resources
     *
     * @return self
     */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 256)) {
            throw new \InvalidArgumentException('invalid length for $name when calling FloatingIp., must be smaller than or equal to 256.');
        }
