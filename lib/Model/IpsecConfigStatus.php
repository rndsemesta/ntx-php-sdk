...
/**
 * IpsecConfigStatus Class Doc Comment
 *
 * @category Class
 ...
 */
class IpsecConfigStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ipsec_config_status';
    ...
    protected static $openAPITypes = [
        ...
        'negotiated_proposal' => '\OpenAPI\Client\Model\IpsecConfigStatusNegotiatedProposal',
    ...
    protected static $attributeMap = [
        ...
        'negotiated_proposal' => 'negotiated_proposal',
    ...
    protected static $setters = [
        ...
        'negotiated_proposal' => 'setNegotiatedProposal',
    ...
    protected static $getters = [
        ...
        'negotiated_proposal' => 'getNegotiatedProposal',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('negotiated_proposal', $data ?? [], null);
    ...
    */
    ...
    public function setRemoteVtiIp($remote_vti_ip)
    {
        ...
        if ((!preg_match("/^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$/", ObjectSerializer::toString($remote_vti_ip)))) {
            throw new \InvalidArgumentException("invalid value for \$remote_vti_ip when calling IpsecConfigStatus., must conform to the pattern /^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$/.");
        }
    ...
    /**
     * Gets negotiated_proposal
     *
     * @return \OpenAPI\Client\Model\IpsecConfigStatusNegotiatedProposal|null
     */
    public function getNegotiatedProposal()
    {
        return $this->container['negotiated_proposal'];
    }

    /**
     * Sets negotiated_proposal
     *
     * @param \OpenAPI\Client\Model\IpsecConfigStatusNegotiatedProposal|null $negotiated_proposal negotiated_proposal
     *
     * @return self
     */
    public function setNegotiatedProposal($negotiated_proposal)
    {
        if (is_null($negotiated_proposal)) {
            throw new \InvalidArgumentException('non-nullable negotiated_proposal cannot be null');
        }
        $this->container['negotiated_proposal'] = $negotiated_proposal;
    ...
    public function setLocalVtiIp($local_vti_ip)
    {
        ...
        if ((!preg_match("/^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$/", ObjectSerializer::toString($local_vti_ip)))) {
            throw new \InvalidArgumentException("invalid value for \$local_vti_ip when calling IpsecConfigStatus., must conform to the pattern /^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$/.");
        }
     ...
     *
     * @param int|null $esp_pfs_dh_group_number Diffie-Hellman group configured for Perfect Forward Secrecy (PFS). Supported DH groups are 14, 19 and 20.
     *
     * @return self
     */
     ...
     * Sets pre_shared_key
     *
     * @param string|null $pre_shared_key Shared secret for authentication between gateway peers. Note that the clear-text secret value specfied in the input spec is never revealed in the status. Use this field only as means to verify if the secret is currently set or not.
     *
     * @return self
     */
