...
/**
 * RecoveryPlanJob Class Doc Comment
 *
 * @category Class
 ...
 */
class RecoveryPlanJob implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'recovery_plan_job';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $name when calling RecoveryPlanJob., must be smaller than or equal to 64.');
        }
