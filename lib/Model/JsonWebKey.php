...
class JsonWebKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'json_web_key';
    ...
    */
     ...
     * Sets use
     *
     * @param string $use How the key should be used
     *
     * @return self
     */
     ...
     * Sets e
     *
     * @param string $e RSA key value (exponent) for key blinding
     *
     * @return self
     */
     ...
     * Sets alg
     *
     * @param string $alg Algorithm intended for use with the key
     *
     * @return self
     */
     ...
     * Sets n
     *
     * @param string $n RSA modulus value
     *
     * @return self
     */
     ...
     * Sets kid
     *
     * @param string|null $kid Unique identifier for the key
     *
     * @return self
     */
