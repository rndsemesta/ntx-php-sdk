...
/**
 * ProtectionRuleDefStatus Class Doc Comment
 *
 * @category Class
 ...
 */
class ProtectionRuleDefStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'protection_rule_def_status';
    ...
    */
     ...
     * Sets state
     *
     * @param string|null $state The state of the protection rule.
     *
     * @return self
     */
     ...
     * Sets message_list
     *
     * @param \OpenAPI\Client\Model\MessageResource[]|null $message_list Any error messages for the protection rule, if in an error state.
     *
     * @return self
     */
