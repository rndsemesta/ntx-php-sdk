...
/**
 * DirectConnect Class Doc Comment
 *
 * @category Class
 ...
 */
class DirectConnect implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'direct_connect';
    ...
    protected static $openAPITypes = [
        ...
        'description' => 'string',
        'resources' => '\OpenAPI\Client\Model\DirectConnectResources',
        'name' => 'string'
    ];
    ...
    */
     ...
     * Sets description
     *
     * @param string|null $description A description for direct_connect.
     *
     * @return self
     */
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $description when calling DirectConnect., must be smaller than or equal to 1000.');
        }
     ...
     * Gets resources
     *
     * @return \OpenAPI\Client\Model\DirectConnectResources
     */
     ...
     * Sets resources
     *
     * @param \OpenAPI\Client\Model\DirectConnectResources $resources resources
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name direct_connect Name.
     *
     * @return self
     */
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 256)) {
            throw new \InvalidArgumentException('invalid length for $name when calling DirectConnect., must be smaller than or equal to 256.');
        }
