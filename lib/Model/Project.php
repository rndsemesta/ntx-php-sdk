...
class Project implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'name' => 'string',
        'resources' => '\OpenAPI\Client\Model\ProjectResources',
        'description' => 'string'
    ];
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Project., must be smaller than or equal to 64.');
        }
     ...
     * Gets resources
     *
     * @return \OpenAPI\Client\Model\ProjectResources
     */
     ...
     * Sets resources
     *
     * @param \OpenAPI\Client\Model\ProjectResources $resources resources
     *
     * @return self
     */
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $description when calling Project., must be smaller than or equal to 1000.');
        }
