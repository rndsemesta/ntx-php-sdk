...
/**
 * VpnConnectionDefStatus Class Doc Comment
 *
 * @category Class
 ...
 */
class VpnConnectionDefStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'vpn_connection_def_status';
    ...
    protected static $openAPITypes = [
        ...
        'resources' => '\OpenAPI\Client\Model\VpnConnectionResourcesDefStatus',
        'description' => 'string'
    ];
    ...
    */
     ...
     * Sets state
     *
     * @param string|null $state The state of the vpn_connection.
     *
     * @return self
     */
     ...
     * Sets message_list
     *
     * @param \OpenAPI\Client\Model\MessageResource[]|null $message_list Any error messages for the vpn_connection, if in an error state.
     *
     * @return self
     */
     ...
     * Gets resources
     *
     * @return \OpenAPI\Client\Model\VpnConnectionResourcesDefStatus
     */
     ...
     * Sets resources
     *
     * @param \OpenAPI\Client\Model\VpnConnectionResourcesDefStatus $resources resources
     *
     * @return self
     */
