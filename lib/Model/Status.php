...
class Status implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets status
     *
     * @param string|null $status Only value possible is \"failure\".
     *
     * @return self
     */
     ...
     * Sets kind
     *
     * @param string|null $kind The entitys kind. i.e. \"status\".
     *
     * @return self
     */
     ...
     * Sets message
     *
     * @param string|null $message A sentence explaining the reason for the status.
     *
     * @return self
     */
