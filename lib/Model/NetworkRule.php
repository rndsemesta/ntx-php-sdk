 ...
 */
class NetworkRule implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'network_rule';
    ...
    protected static $openAPITypes = [
        ...
        'icmp_type_code_list' => '\OpenAPI\Client\Model\NetworkRuleIcmpTypeCodeListInner[]',
    ...
    */
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 64)) {
            throw new \InvalidArgumentException('invalid length for $description when calling NetworkRule., must be smaller than or equal to 64.');
        }
     ...
     *
     * @param \OpenAPI\Client\Model\PortRange[]|null $tcp_port_range_list List of TCP ports that are allowed by this rule.
     *
     * @return self
     */
     ...
     *
     * @param \OpenAPI\Client\Model\PortRange[]|null $udp_port_range_list List of UDP ports that are allowed by this rule.
     *
     * @return self
     */
     ...
     *
     * @param \OpenAPI\Client\Model\ServiceGroupReference[]|null $service_group_list List of service groups associated with this rule. The exiting fields for protocol or ports is not recommended for use and will be deprecated for these new fields at the API level.
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\NetworkRuleIcmpTypeCodeListInner[]|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\NetworkRuleIcmpTypeCodeListInner[]|null $icmp_type_code_list List of ICMP types and codes allowed by this rule.
     *
     * @return self
     */
    ...
    public function setExpirationTime($expiration_time)
    {
        ...
        if ((mb_strlen($expiration_time) > 64)) {
            throw new \InvalidArgumentException('invalid length for $expiration_time when calling NetworkRule., must be smaller than or equal to 64.');
        }
    ...
    public function setRuleId($rule_id)
    {
        ...
        if (($rule_id > 4095)) {
            throw new \InvalidArgumentException('invalid value for $rule_id when calling NetworkRule., must be smaller than or equal to 4095.');
        }
        if (($rule_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $rule_id when calling NetworkRule., must be bigger than or equal to 0.');
        }
