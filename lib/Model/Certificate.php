...
class Certificate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setContent($content)
    {
        ...
        if ((!preg_match("/^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$/", ObjectSerializer::toString($content)))) {
            throw new \InvalidArgumentException("invalid value for \$content when calling Certificate., must conform to the pattern /^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$/.");
        }
