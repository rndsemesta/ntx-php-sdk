 ...
 */
class VolumeGroup implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'volume_group';
    ...
    protected static $openAPITypes = [
        'name' => 'string',
        'description' => 'string',
        'resources' => '\OpenAPI\Client\Model\VolumeGroupResourcesInput',
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 256)) {
            throw new \InvalidArgumentException('invalid length for $name when calling VolumeGroup., must be smaller than or equal to 256.');
        }
     ...
     * Sets description
     *
     * @param string|null $description Volume group description.
     *
     * @return self
     */
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $description when calling VolumeGroup., must be smaller than or equal to 1000.');
        }
     ...
     * Gets resources
     *
     * @return \OpenAPI\Client\Model\VolumeGroupResourcesInput
     */
     ...
     * Sets resources
     *
     * @param \OpenAPI\Client\Model\VolumeGroupResourcesInput $resources resources
     *
     * @return self
     */
