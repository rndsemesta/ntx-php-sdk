...
/**
 * ProjectResources3 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ProjectResources3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Project_Resources_3';
    ...
    */
     ...
     *
     * @param \OpenAPI\Client\Model\UserReference[]|null $user_reference_list List of users in the project including all the users from the users group if provided.
     *
     * @return self
     */
