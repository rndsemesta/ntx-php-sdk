...
/**
 * DirectoryServiceSearchResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class DirectoryServiceSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'directory_service_search_response';
    ...
    protected static $openAPITypes = [
        'search_result_list' => '\OpenAPI\Client\Model\Entity[]',
        'domain_name' => 'string',
        'api_version' => 'string',
        'metadata' => '\OpenAPI\Client\Model\DirectoryServiceSearchMetadata'
    ];
    ...
    {
        $this->setIfExists('search_result_list', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['search_result_list'];
    }

    /**
     * Sets search_result_list
     *
     * @param \OpenAPI\Client\Model\Entity[]|null $search_result_list search_result_list
     *
     * @return self
     */
    public function setSearchResultList($search_result_list)
    {
        if (is_null($search_result_list)) {
            throw new \InvalidArgumentException('non-nullable search_result_list cannot be null');
        }
        $this->container['search_result_list'] = $search_result_list;
     ...
     * Gets metadata
     *
     * @return \OpenAPI\Client\Model\DirectoryServiceSearchMetadata|null
     */
     ...
     * Sets metadata
     *
     * @param \OpenAPI\Client\Model\DirectoryServiceSearchMetadata|null $metadata metadata
     *
     * @return self
     */
