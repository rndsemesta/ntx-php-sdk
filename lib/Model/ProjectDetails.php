...
class ProjectDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'name' => 'string',
        'resources' => '\OpenAPI\Client\Model\ProjectResources1',
        'description' => 'string'
    ];
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ProjectDetails., must be smaller than or equal to 64.');
        }
     ...
     * Gets resources
     *
     * @return \OpenAPI\Client\Model\ProjectResources1
     */
     ...
     * Sets resources
     *
     * @param \OpenAPI\Client\Model\ProjectResources1 $resources resources
     *
     * @return self
     */
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $description when calling ProjectDetails., must be smaller than or equal to 1000.');
        }
