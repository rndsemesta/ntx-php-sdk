 ...
 */
class DeploymentStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'deployment_status';
    ...
    protected static array $openAPINullables = [
        ...
        'supported_software_version' => false,
    ...
    protected static $setters = [
        ...
        'supported_software_version' => 'setSupportedSoftwareVersion',
    ...
    protected static $getters = [
        ...
        'supported_software_version' => 'getSupportedSoftwareVersion',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('supported_software_version', $data ?? [], null);
    ...
    */
    ...
    public function setStaticIp($static_ip)
    {
        ...
        if ((!preg_match("/^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$/", ObjectSerializer::toString($static_ip)))) {
            throw new \InvalidArgumentException("invalid value for \$static_ip when calling DeploymentStatus., must conform to the pattern /^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$/.");
        }
    ...
    public function setDefaultGatewayIp($default_gateway_ip)
    {
        ...
        if ((!preg_match("/^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$/", ObjectSerializer::toString($default_gateway_ip)))) {
            throw new \InvalidArgumentException("invalid value for \$default_gateway_ip when calling DeploymentStatus., must conform to the pattern /^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$/.");
        }
     ...
     *
     * @param string|null $image_source_url The software image installed on the gateway appliance.
     *
     * @return self
     */
    ...
    /**
     * Gets supported_software_version
     *
     * @return string|null
     */
    public function getSupportedSoftwareVersion()
    {
        return $this->container['supported_software_version'];
    }

    /**
     * Sets supported_software_version
     *
     * @param string|null $supported_software_version The supported gateway appliance version.
     *
     * @return self
     */
    public function setSupportedSoftwareVersion($supported_software_version)
    {
        if (is_null($supported_software_version)) {
            throw new \InvalidArgumentException('non-nullable supported_software_version cannot be null');
        }
        $this->container['supported_software_version'] = $supported_software_version;
     ...
     *
     * @param string|null $installed_software_version The software version installed on the gateway appliance.
     *
     * @return self
     */
     ...
     * Sets vlan_id
     *
     * @param int|null $vlan_id The on-prem VLAN to deploy the VPN gateway on.
     *
     * @return self
     */
