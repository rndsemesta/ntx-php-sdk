...
/**
 * VpnGatewayResources Class Doc Comment
 *
 * @category Class
 ...
 */
class VpnGatewayResources implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'vpn_gateway_resources';
    ...
    protected static $openAPITypes = [
        ...
        'public_ip' => 'string',
        'gateway_type' => 'string',
        'deployment' => '\OpenAPI\Client\Model\Deployment',
        'internal_routing_protocol_config' => '\OpenAPI\Client\Model\InternalRoutingProtocolConfig',
        'ebgp_config' => '\OpenAPI\Client\Model\BgpConfig',
    ...
    */
    ...
    public function setPublicIp($public_ip)
    {
        ...
        if ((!preg_match("/^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$/", ObjectSerializer::toString($public_ip)))) {
            throw new \InvalidArgumentException("invalid value for \$public_ip when calling VpnGatewayResources., must conform to the pattern /^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$/.");
        }
     ...
     * Sets gateway_type
     *
     * @param string $gateway_type Whether this is local or remote gateway entity.
     *
     * @return self
     */
     ...
     * Gets deployment
     *
     * @return \OpenAPI\Client\Model\Deployment|null
     */
     ...
     * Sets deployment
     *
     * @param \OpenAPI\Client\Model\Deployment|null $deployment deployment
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\InternalRoutingProtocolConfig|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\InternalRoutingProtocolConfig|null $internal_routing_protocol_config internal_routing_protocol_config
     *
     * @return self
     */
     ...
     * Sets ebgp_config
     *
     * @param \OpenAPI\Client\Model\BgpConfig|null $ebgp_config ebgp_config
     *
     * @return self
     */
