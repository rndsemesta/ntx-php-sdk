...
/**
 * CategoryMappingResourcesAdMapping Class Doc Comment
 *
 * @category Class
 ...
 */
class CategoryMappingResourcesAdMapping implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'category_mapping_resources_ad_mapping';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['object_identifier'] === null) {
            $invalidProperties[] = "'object_identifier' can't be null";
        }
        if ((mb_strlen($this->container['object_identifier']) > 200)) {
            $invalidProperties[] = "invalid value for 'object_identifier', the character length must be smaller than or equal to 200.";
        }
     ...
     *
     * @param string $object_identifier The objectGUID for the object in AD.
     *
     * @return self
     */
    public function setObjectIdentifier($object_identifier)
    {
        ...
        if ((mb_strlen($object_identifier) > 200)) {
            throw new \InvalidArgumentException('invalid length for $object_identifier when calling CategoryMappingResourcesAdMapping., must be smaller than or equal to 200.');
        }
