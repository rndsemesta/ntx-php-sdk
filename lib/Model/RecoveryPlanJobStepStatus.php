...
/**
 * RecoveryPlanJobStepStatus Class Doc Comment
 *
 * @category Class
 ...
 */
class RecoveryPlanJobStepStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'recovery_plan_job_step_status';
    ...
    */
     ...
     * Sets status
     *
     * @param string $status State of a step.
     *
     * @return self
     */
     ...
     *
     * @param int $percentage_complete Percentage completed for a step.
     *
     * @return self
     */
