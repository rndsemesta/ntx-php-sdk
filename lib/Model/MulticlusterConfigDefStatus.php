...
/**
 * MulticlusterConfigDefStatus Class Doc Comment
 *
 * @category Class
 ...
 */
class MulticlusterConfigDefStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'multicluster_config_def_status';
    ...
    */
     ...
     * Sets state
     *
     * @param string|null $state The state of the multicluster configuration request.
     *
     * @return self
     */
