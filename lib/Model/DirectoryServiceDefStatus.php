...
/**
 * DirectoryServiceDefStatus Class Doc Comment
 *
 * @category Class
 ...
 */
class DirectoryServiceDefStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'directory_service_def_status';
    ...
    protected static $openAPITypes = [
        ...
        'name' => 'string',
        'resources' => '\OpenAPI\Client\Model\DirectoryServiceResources'
    ];
    ...
    */
     ...
     * Sets state
     *
     * @param string|null $state The state of the directory service configuration.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name Name of the directory service.
     *
     * @return self
     */
     ...
     * Gets resources
     *
     * @return \OpenAPI\Client\Model\DirectoryServiceResources
     */
     ...
     * Sets resources
     *
     * @param \OpenAPI\Client\Model\DirectoryServiceResources $resources resources
     *
     * @return self
     */
