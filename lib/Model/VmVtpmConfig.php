...
/**
 * VmVtpmConfig Class Doc Comment
 *
 * @category Class
 ...
 */
class VmVtpmConfig implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'vm_vtpm_config';
    ...
    */
     ...
     * Sets vtpm_enabled
     *
     * @param bool|null $vtpm_enabled Indicates whether virtual trusted platform module should be enabled for the Guest OS.
     *
     * @return self
     */
