...
class Permission implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'name' => 'string',
        'resources' => '\OpenAPI\Client\Model\PermissionResources',
        'description' => 'string'
    ];
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Permission., must be smaller than or equal to 64.');
        }
     ...
     * Gets resources
     *
     * @return \OpenAPI\Client\Model\PermissionResources
     */
     ...
     * Sets resources
     *
     * @param \OpenAPI\Client\Model\PermissionResources $resources resources
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description A description or user annotation for the permission.
     *
     * @return self
     */
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $description when calling Permission., must be smaller than or equal to 1000.');
        }
