<?php
/**
 * DirectConnectVirtualInterfaceDefStatus
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * DirectConnectVirtualInterfaceDefStatus Class Doc Comment
 *
 * @category Class
 ...
 */
class DirectConnectVirtualInterfaceDefStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'direct_connect_virtual_interface_def_status';
    ...
    protected static $openAPITypes = [
        ...
        'resources' => '\OpenAPI\Client\Model\DirectConnectVirtualInterfaceResourcesDefStatus',
        'description' => 'string'
    ];
    ...
    */
     ...
     * Sets name
     *
     * @param string $name direct_connect_virtual_interface Name.
     *
     * @return self
     */
     ...
     * Sets state
     *
     * @param string|null $state The state of the direct_connect_virtual_interface.
     *
     * @return self
     */
     ...
     * Sets message_list
     *
     * @param \OpenAPI\Client\Model\MessageResource[]|null $message_list Any error messages for the direct_connect_virtual_interface, if in an error state.
     *
     * @return self
     */
     ...
     * Gets resources
     *
     * @return \OpenAPI\Client\Model\DirectConnectVirtualInterfaceResourcesDefStatus
     */
     ...
     * Sets resources
     *
     * @param \OpenAPI\Client\Model\DirectConnectVirtualInterfaceResourcesDefStatus $resources resources
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description A description for direct_connect_virtual_interface.
     *
     * @return self
     */
