...
/**
 * ClusterSynchronousReplicationCapableResponseInner Class Doc Comment
 *
 * @category Class
 ...
 */
class ClusterSynchronousReplicationCapableResponseInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'cluster_synchronous_replication_capable_response_inner';
    ...
    {
        $this->setIfExists('rtt_msecs', $data ?? [], null);
    ...
    */
     ...
     * @return string|null
     */
    public function getRttMsecs()
    {
        return $this->container['rtt_msecs'];
    }

    /**
     * Sets rtt_msecs
     *
     * @param string|null $rtt_msecs Round trip time in milliseconds.
     *
     * @return self
     */
    public function setRttMsecs($rtt_msecs)
    {
        if (is_null($rtt_msecs)) {
            throw new \InvalidArgumentException('non-nullable rtt_msecs cannot be null');
        }
        $this->container['rtt_msecs'] = $rtt_msecs;
