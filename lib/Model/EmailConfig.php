 ...
 */
class EmailConfig implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'email_config';
    ...
    */
     ...
     * Sets email_subject
     *
     * @param string|null $email_subject Subject of email to be sent for report.
     *
     * @return self
     */
     ...
     * Sets email_body
     *
     * @param string|null $email_body Content of the email body.
     *
     * @return self
     */
     ...
     * Sets recipient_list
     *
     * @param \OpenAPI\Client\Model\Recipient[]|null $recipient_list Email recipients list.
     *
     * @return self
     */
    public function setRecipientList($recipient_list)
    {
        ...
        if ((count($recipient_list) > 100)) {
            throw new \InvalidArgumentException('invalid value for $recipient_list when calling EmailConfig., number of items must be less than or equal to 100.');
        }
