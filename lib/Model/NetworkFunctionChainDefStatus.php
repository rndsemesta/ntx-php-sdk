...
/**
 * NetworkFunctionChainDefStatus Class Doc Comment
 *
 * @category Class
 ...
 */
class NetworkFunctionChainDefStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'network_function_chain_def_status';
    ...
    */
     ...
     * Sets state
     *
     * @param string|null $state The state of the entity.
     *
     * @return self
     */
