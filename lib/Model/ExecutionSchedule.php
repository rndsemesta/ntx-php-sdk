...
/**
 * ExecutionSchedule Class Doc Comment
 *
 * @category Class
 ...
 */
class ExecutionSchedule implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'execution_schedule';
    ...
    */
     ...
     * Sets start_time
     *
     * @param \DateTime $start_time Start time to execute a request.
     *
     * @return self
     */
     ...
     * Sets time_zone
     *
     * @param string|null $time_zone Name of specified time zone.
     *
     * @return self
     */
     ...
     * Sets timeout_secs
     *
     * @param int|null $timeout_secs Time out in seconds for a request execution.
     *
     * @return self
     */
