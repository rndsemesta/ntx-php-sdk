...
/**
 * CloudCredentialsDefStatus Class Doc Comment
 *
 * @category Class
 ...
 */
class CloudCredentialsDefStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'cloud_credentials_def_status';
    ...
    */
     ...
     * Sets id
     *
     * @param int $id ID to uniquely identify cloud credentials
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name Credentials name.
     *
     * @return self
     */
