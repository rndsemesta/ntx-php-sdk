...
/**
 * VmVtpmStatus Class Doc Comment
 *
 * @category Class
 ...
 */
class VmVtpmStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'vm_vtpm_status';
    ...
    {
        $this->setIfExists('vtpm_enabled', $data ?? [], null);
    ...
    */
     ...
     * @return bool|null
     */
    public function getVtpmEnabled()
    {
        return $this->container['vtpm_enabled'];
    }

    /**
     * Sets vtpm_enabled
     *
     * @param bool|null $vtpm_enabled Indicates whether virtual trusted platform module is enabled for the the Guest OS.
     *
     * @return self
     */
    public function setVtpmEnabled($vtpm_enabled)
    {
        if (is_null($vtpm_enabled)) {
            throw new \InvalidArgumentException('non-nullable vtpm_enabled cannot be null');
        }
        $this->container['vtpm_enabled'] = $vtpm_enabled;
     ...
     * Sets version
     *
     * @param string|null $version Virtual trusted platform module version.
     *
     * @return self
     */
