...
/**
 * VirtualNetworkDefStatus Class Doc Comment
 *
 * @category Class
 ...
 */
class VirtualNetworkDefStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'virtual_network_def_status';
    ...
    protected static $openAPITypes = [
        ...
        'name' => 'string',
        'resources' => '\OpenAPI\Client\Model\VirtualNetworkResourcesDefStatus',
        'description' => 'string'
    ];
    ...
    */
     ...
     * Sets state
     *
     * @param string|null $state The state of the virtual network.
     *
     * @return self
     */
     ...
     * Sets message_list
     *
     * @param \OpenAPI\Client\Model\MessageResource[]|null $message_list Any error messages for the virtual network, if in an error state.
     *
     * @return self
     */
     ...
     * Gets resources
     *
     * @return \OpenAPI\Client\Model\VirtualNetworkResourcesDefStatus|null
     */
     ...
     * Sets resources
     *
     * @param \OpenAPI\Client\Model\VirtualNetworkResourcesDefStatus|null $resources resources
     *
     * @return self
     */
