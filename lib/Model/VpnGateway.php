 ...
 */
class VpnGateway implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'vpn_gateway';
    ...
    protected static $openAPITypes = [
        ...
        'description' => 'string',
        'resources' => '\OpenAPI\Client\Model\VpnGatewayResources',
        'name' => 'string'
    ];
    ...
    */
     ...
     * Sets description
     *
     * @param string|null $description A description for vpn_gateway.
     *
     * @return self
     */
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $description when calling VpnGateway., must be smaller than or equal to 1000.');
        }
     ...
     * Gets resources
     *
     * @return \OpenAPI\Client\Model\VpnGatewayResources
     */
     ...
     * Sets resources
     *
     * @param \OpenAPI\Client\Model\VpnGatewayResources $resources resources
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name vpn_gateway Name.
     *
     * @return self
     */
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 256)) {
            throw new \InvalidArgumentException('invalid length for $name when calling VpnGateway., must be smaller than or equal to 256.');
        }
