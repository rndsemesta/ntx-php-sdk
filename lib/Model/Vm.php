 ...
 */
class Vm implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'vm';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 256)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Vm., must be smaller than or equal to 256.');
        }
     ...
     * Sets description
     *
     * @param string|null $description A description for vm.
     *
     * @return self
     */
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $description when calling Vm., must be smaller than or equal to 1000.');
        }
     ...
     * Gets resources
     *
     * @return \OpenAPI\Client\Model\VmResources
     */
     ...
     * Sets resources
     *
     * @param \OpenAPI\Client\Model\VmResources $resources resources
     *
     * @return self
     */
