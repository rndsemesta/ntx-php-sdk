...
class OauthClientResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'oauth_client_response';
    ...
    */
    ...
    public function setClientName($client_name)
    {
        ...
        if ((mb_strlen($client_name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $client_name when calling OauthClientResponse., must be smaller than or equal to 64.');
        }
    ...
    public function setClientDescription($client_description)
    {
        ...
        if ((mb_strlen($client_description) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $client_description when calling OauthClientResponse., must be smaller than or equal to 1000.');
        }
