...
/**
 * FloatingIpDefStatus Class Doc Comment
 *
 * @category Class
 ...
 */
class FloatingIpDefStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'floating_ip_def_status';
    ...
    protected static $openAPITypes = [
        ...
        'resources' => '\OpenAPI\Client\Model\FloatingIpResourcesDefStatus',
        'description' => 'string'
    ];
    ...
    */
     ...
     * Sets name
     *
     * @param string $name floating_ip Name.
     *
     * @return self
     */
     ...
     * Sets state
     *
     * @param string|null $state The state of the floating_ip.
     *
     * @return self
     */
     ...
     * Sets message_list
     *
     * @param \OpenAPI\Client\Model\MessageResource[]|null $message_list Any error messages for the floating_ip, if in an error state.
     *
     * @return self
     */
     ...
     * Gets resources
     *
     * @return \OpenAPI\Client\Model\FloatingIpResourcesDefStatus
     */
     ...
     * Sets resources
     *
     * @param \OpenAPI\Client\Model\FloatingIpResourcesDefStatus $resources resources
     *
     * @return self
     */
