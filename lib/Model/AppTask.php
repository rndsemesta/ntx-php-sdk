 ...
 */
class AppTask implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'app_task';
    ...
    protected static $openAPITypes = [
        ...
        'description' => 'string',
        'resources' => '\OpenAPI\Client\Model\AppTaskResources',
    ...
    */
     ...
     * Sets name
     *
     * @param string $name app_task Name.
     *
     * @return self
     */
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 256)) {
            throw new \InvalidArgumentException('invalid length for $name when calling AppTask., must be smaller than or equal to 256.');
        }
     ...
     * Sets description
     *
     * @param string|null $description A description for app_task.
     *
     * @return self
     */
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $description when calling AppTask., must be smaller than or equal to 1000.');
        }
     ...
     * Gets resources
     *
     * @return \OpenAPI\Client\Model\AppTaskResources
     */
     ...
     * Sets resources
     *
     * @param \OpenAPI\Client\Model\AppTaskResources $resources resources
     *
     * @return self
     */
