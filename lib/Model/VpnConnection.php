...
/**
 * VpnConnection Class Doc Comment
 *
 * @category Class
 ...
 */
class VpnConnection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'vpn_connection';
    ...
    protected static $openAPITypes = [
        ...
        'description' => 'string',
        'resources' => '\OpenAPI\Client\Model\VpnConnectionResources',
        'name' => 'string'
    ];
    ...
    */
     ...
     * Sets description
     *
     * @param string|null $description A description for vpn_connection.
     *
     * @return self
     */
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $description when calling VpnConnection., must be smaller than or equal to 1000.');
        }
     ...
     * Gets resources
     *
     * @return \OpenAPI\Client\Model\VpnConnectionResources
     */
     ...
     * Sets resources
     *
     * @param \OpenAPI\Client\Model\VpnConnectionResources $resources resources
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name vpn_connection Name.
     *
     * @return self
     */
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 256)) {
            throw new \InvalidArgumentException('invalid length for $name when calling VpnConnection., must be smaller than or equal to 256.');
        }
